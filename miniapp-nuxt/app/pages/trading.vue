  ...
  >
    ...
    <header class="flex-shrink-0 text-center mb-8">
      ...
      <div class="flex justify-center gap-8 md:gap-6 mt-4">
        <span
          class="text-[0.95em] text-[var(--tg-theme-hint-color,#9ca3af)] font-medium"
        >
          <strong
    ...
    >
      <UIcon
        ...
        class="w-12 h-12 text-[#667eea] animate-spin mb-4"
      />
    ...
    >
      <p
        class="text-lg text-[var(--tg-theme-hint-color,#9ca3af)] font-medium mb-4"
      >
        {{ store.error }}
      </p>
      <UButton
    ...
    <div v-else class="flex flex-col gap-3 flex-grow pb-5">
      ...
      >
        <DisplayDataTradePair :pair="pair" />
      </UCard>
      ...
      >
        <p
          class="text-lg text-[var(--tg-theme-hint-color,#9ca3af)] font-medium"
        >
