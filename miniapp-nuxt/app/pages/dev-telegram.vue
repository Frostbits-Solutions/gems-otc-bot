...
const storeData = computed(() => ({
  ...
  isActive:
    telegramStore.isActive !== undefined
      ? telegramStore.isActive
      : "Not available",
  colorScheme: telegramStore.tg?.colorScheme || "Not available",
  isExpanded:
    telegramStore.tg?.isExpanded !== undefined
      ? telegramStore.tg.isExpanded
      : "Not available",
  viewportHeight: telegramStore.tg?.viewportHeight || "Not available",
  viewportStableHeight:
    telegramStore.tg?.viewportStableHeight || "Not available",
}));
</script>
  ...
  <div class="dev-container">
    ...
    <div class="section">
      ...
      <div v-if="telegramStore.initDataUnsafe?.user" class="data-grid">
        ...
        <div class="data-item">
          ...
          <span class="value">{{
            telegramStore.initDataUnsafe.user.first_name
          }}</span>
        </div>
        <div
          class="data-item"
          v-if="telegramStore.initDataUnsafe.user.last_name"
        >
          <span class="label">Last Name:</span>
          <span class="value">{{
            telegramStore.initDataUnsafe.user.last_name
          }}</span>
        </div>
        <div
          class="data-item"
          v-if="telegramStore.initDataUnsafe.user.username"
        >
          <span class="label">Username:</span>
          <span class="value"
            >@{{ telegramStore.initDataUnsafe.user.username }}</span
          >
        </div>
        <div
          class="data-item"
          v-if="telegramStore.initDataUnsafe.user.language_code"
        >
          <span class="label">Language:</span>
          <span class="value">{{
            telegramStore.initDataUnsafe.user.language_code
          }}</span>
        </div>
        <div
          class="data-item"
          v-if="telegramStore.initDataUnsafe.user.is_premium"
        >
        ...
        <div
          class="data-item"
          v-if="telegramStore.initDataUnsafe.user.photo_url"
        >
          <span class="label">Photo URL:</span>
          <span class="value small">{{
            telegramStore.initDataUnsafe.user.photo_url
          }}</span>
        </div>
      </div>
    ...
    <div class="section">
      ...
      <div v-if="telegramStore.initDataUnsafe?.chat" class="data-grid">
        ...
        <div class="data-item">
          ...
          <span class="value">{{
            telegramStore.initDataUnsafe.chat.type
          }}</span>
        </div>
        <div class="data-item">
          <span class="label">Title:</span>
          <span class="value">{{
            telegramStore.initDataUnsafe.chat.title
          }}</span>
        </div>
        <div
          class="data-item"
          v-if="telegramStore.initDataUnsafe.chat.username"
        >
          <span class="label">Username:</span>
          <span class="value"
            >@{{ telegramStore.initDataUnsafe.chat.username }}</span
          >
        </div>
      </div>
      <div v-else class="no-data">
    ...
    <div class="section">
      ...
      <div v-if="telegramStore.initDataUnsafe" class="data-grid">
        ...
        <div class="data-item">
          ...
          <span class="value">{{
            new Date(
              telegramStore.initDataUnsafe.auth_date * 1000,
            ).toLocaleString()
          }}</span>
        </div>
        <div class="data-item">
          ...
          <span class="value small">{{
            telegramStore.initDataUnsafe.hash
          }}</span>
        </div>
      </div>
      <div v-else class="no-data">
    ...
    <div class="section">
      ...
      <pre class="json-display">{{
        formatJson(telegramStore.initDataUnsafe)
      }}</pre>
    </div>
    ...
    <div class="section">
      ...
      <div v-if="telegramStore.tg?.themeParams" class="theme-colors">
        <div
          v-for="(value, key) in telegramStore.tg.themeParams"
          :key="key"
          class="color-item"
        >
    ...
    <div class="section warning">
      ...
      <p>
        The data displayed here is from <code>initDataUnsafe</code> and has not
        been validated. Always validate this data on your backend before
        trusting it.
      </p>
      <p>
        <a
